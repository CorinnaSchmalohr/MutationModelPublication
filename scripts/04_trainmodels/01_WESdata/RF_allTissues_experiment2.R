...
# })
# save(imp, file = paste0("data/Modeling/exomeTrainData/RF/TissueCombination2",
...
predictions = lapply(chroms, function(cr){
  ...
  save(rf, file = paste0("data/Modeling/exomeTrainData/RF/TissueCombination2", "_", 
...
save(predictions, file = paste0("data/Modeling/exomeTrainData/RF/TissueCombination2",
                                "_predictions.RData"))
cat('\n')
#####
...
rf = ranger(mutated ~ ., data = combDat,
            ...
            respect.unordered.factors = 'partition',
            probability = T, verbose=F)
save(rf, importance, file = paste0("data/Modeling/exomeTrainData/RF/TissueCombination2_", 
                                   "finalModel.RData"))
