...
# nPermutations = 10000
# maxData = 50000
dir.create("data/Modeling/exomeTrainData_subsampled/",showWarnings=F)
dir.create("data/Modeling/exomeTrainData_subsampled/RF",showWarnings=F)
...
# dumpVar = sapply(tissues, function(tissue){
  ...
  save(imp, file = paste0("data/Modeling/exomeTrainData_subsampled/RF/", tissue,
  ...
  predictions = lapply(chroms, function(cr){
    ...
    rf = ranger(mutated ~ ., data = trainData,
                ...
                respect.unordered.factors = 'partition',
                probability = T, verbose=F)
    save(rf, file = paste0("data/Modeling/exomeTrainData_subsampled/RF/", tissue, "_", 
  ...
  save(predictions, file = paste0("data/Modeling/exomeTrainData_subsampled/RF/", tissue,
                                  "_predictions.RData"))
  cat('\n')
  #####
  ...
  rf = ranger(mutated ~ ., data = dat,
              ...
              respect.unordered.factors = 'partition',
              probability = T, verbose=F)
  save(rf, importance, file = paste0("data/Modeling/exomeTrainData_subsampled/RF/", tissue, "_", 
                                     "finalModel.RData"))
