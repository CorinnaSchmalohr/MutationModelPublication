...
partial_dir <- "/data/MutTables/WholeGenomeData/partial/partial2/"
...
process_tissue_partial <- function(tissue, start_part, end_part) {
  ...
  process_part <- function(part_num) {
    ...
    result <- tryCatch({
      ...
      output_file <- paste0("data/MutTables/WholeGenomeData/partial/partial2/",
...
if (part_range == "1-2") {
  ...
  stop("Invalid part range. Use '1-2' or '51-100'")
}
